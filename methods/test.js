...
module.exports = {
	/**
	 * @name test
	 * @description Ceci est une méthode de démonstration qui cherche l'ID d'un message pour renvoyer le contenu de ce dernier.
	 * @function run
	 * @param {JSON} message
	...
	name: "test",
	description:
		"Ceci est une methode de demonstration qui cherche l'id dun message pour renvoyer le message",
